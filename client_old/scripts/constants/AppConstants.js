define(['lib/key-mirror'], function(KeyMirror){
    console.log((window.document.location.host === 'www.bustabit.com' || window.document.location.host === 'www.moneypot.com') ? 'https://g2.moneypot.com' : window.document.location.host.replace(/:3841$/, ':3842'))
    return {
